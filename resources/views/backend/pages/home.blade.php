                ...
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card info-card sales-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">@lang('dash-sidebar.nav-products') <span></span></h5>
                    ...
                    <div class="col-xxl-4 col-xl-12">
                        ...
                        <div class="card info-card customers-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">@lang('dash-sidebar.nav-players') <span>/span></h5>
                                    ...
                                    @foreach ($products as $product)
                                        <tr>
                                            ...
                                            <th scope="row"><a href="#"><img src="{{ asset($product->image_path)}}"
                                                                             alt="{{ $product->id }}" width="75"></a>
                                            </th>
                                            <td>
                                                <a href="{{ route('single_product_page', [app()->getLocale(),$product->id ] ) }}"
                                            ...
                                            <td>
                                                <form
                                                    ...
                                                    <a class="btn btn-info"
                                                       href="{{ route('products.show',[app()->getLocale() ,$product->id]) }}"><i
                                                            class="bi bi-eye"></i></a>
